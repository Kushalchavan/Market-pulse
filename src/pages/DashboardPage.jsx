        ...
        <Card className="pt-0">
          <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
            <div className="grid flex-1 gap-1">
              <CardTitle>AAPL - Global Markets</CardTitle>
              <CardDescription>
                Total Stocks for the last 3 months
              </CardDescription>
            </div>
            ...
            >
              <AreaChart data={filteredData}>
                ...
                <Area
                  ...
                  stackId="a"
                />
                <ChartLegendContent content={<ChartLegendContent />} />
              </AreaChart>
            </ChartContainer>
          </CardContent>
        </Card>
